...
namespace Unity.ContentManager
{
    ...
    {
        const string k_DefaultInstalledSettingKeyFormat = "{0}_default-installed";
...
#pragma warning disable 649
        ...
        [SerializeField]
        [Tooltip("If enabled, the Content Manager will automatically ensure this pack is installed the first time it is found in the project.")]
        bool m_InstallByDefault;
...
#pragma warning restore 649
        ...
        {
            get => m_InstallByDefault;
            internal set => m_InstallByDefault = value;
        }

        internal string DefaultInstalledSettingKey => string.Format(k_DefaultInstalledSettingKeyFormat, m_PackageName);
