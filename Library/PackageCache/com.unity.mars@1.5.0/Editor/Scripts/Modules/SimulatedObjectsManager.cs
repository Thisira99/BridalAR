...
namespace UnityEditor.MARS.Simulation
{
        ...
        IModuleDependency<SceneWatchdogModule>
    {
        ...
        // This is used by MARS in-Editor tutorials to remove SceneObjectGuid from simulation copies
        // ReSharper disable once MemberCanBePrivate.Global
        // ReSharper disable once CollectionNeverUpdated.Global
        internal List<Type> ComponentTypesToRemoveFromCopies { get; } = new List<Type>();
        ...
        void IModule.UnloadModule()
        {
            ...
            ComponentTypesToRemoveFromCopies.Clear();
        ...
        void CopySimulatablesToSimulationScene()
        {
            ...
            // Optionally remove other components from copies
            foreach (var type in ComponentTypesToRemoveFromCopies)
            {
                var components = SimulatedContentRoot.GetComponentsInChildren(type, true);
