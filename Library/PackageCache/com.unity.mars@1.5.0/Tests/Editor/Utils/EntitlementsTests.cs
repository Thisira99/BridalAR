...
namespace Unity.MARS.Tests
{
    class EntitlementUtilsTests
    {
        ...
        public IEnumerator CurrentEditorMarsIsEntitled()
        {
            ...
            {
                var disableEmailBypass = Entitlements.DisableUnityEmailBypass;
                var disableProBypass = Entitlements.DisableUnityProBypass;
                var alwaysFail = Entitlements.EntitlementsAlwaysFail;

                Entitlements.DisableUnityEmailBypass = false;
                Entitlements.DisableUnityProBypass = false;
                ...
                {
                    Entitlements.DisableUnityEmailBypass = disableEmailBypass;
                    Entitlements.DisableUnityProBypass = disableProBypass;
