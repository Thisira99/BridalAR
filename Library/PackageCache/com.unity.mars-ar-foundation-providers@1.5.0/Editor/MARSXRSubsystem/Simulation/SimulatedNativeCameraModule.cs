...
#define ARSUBSYSTEMS_2_1_OR_NEWER
#define ARSUBSYSTEMS_3_OR_NEWER
#define ARSUBSYSTEMS_4_OR_NEWER
#endif
...
namespace Unity.MARS.XRSubsystem
{
    class SimulatedNativeCameraModule : IModuleDependency<MARSSceneModule>, IModuleDependency<CompositeRenderModule>,
        IModuleDependency<MarsXRSubsystemModule>, IModuleBehaviorCallbacks, IUsesLightEstimation, IUsesCameraPose
    {
...
#pragma warning restore 649
        ...
        UniversalRendererData m_ModifiedForwardRendererData;
        ...
        void IModuleDependency<MarsXRSubsystemModule>.ConnectDependency(MarsXRSubsystemModule dependency) { }
        ...
        {
            m_Active = MarsXRSubsystemModule.SubsystemsInUse;
            if (!m_Active || !Application.isPlaying)
                return;
        ...
        bool SetupScriptableSimulatedBackground(CompositeRenderContext compositeContext)
        {
            ...
            if (m_CurrentRenderPipeline is UniversalRenderPipelineAsset urpAsset)
            {
                ...
                int backgroundIndex;
                if (SimulatedNativeCameraSettings.instance.compositeForwardRendererData is UniversalRendererData rendererData)
                {
                ...
                if (urpAsset.GetRendererData(sessionCameraActiveRendererIndex) is UniversalRendererData sessionForwardRendererData)
                {
